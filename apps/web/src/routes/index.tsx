...
export const router = createBrowserRouter([
  ...
  { path: "/lms/dashboard/achievements", element: <Navigate to="/lms/me/certificates" replace /> },
  ...
  { path: "/dashboard/learning/achievements", element: <Navigate to="/lms/me/certificates" replace /> },
