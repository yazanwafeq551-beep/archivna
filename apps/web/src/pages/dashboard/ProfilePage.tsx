          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <Avatar className="h-20 w-20">
                <AvatarImage src={avatarPreview || user?.avatarPath} alt={user?.fullName} />
                <AvatarFallback className="text-lg">{getInitials(user?.fullName || "")}</AvatarFallback>
              </Avatar>
              <label className="absolute -bottom-1 -start-1 cursor-pointer rounded-full bg-primary p-1.5 text-white shadow-sm hover:bg-primary-dark">
